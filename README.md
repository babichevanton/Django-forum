...
Что реализовано в задании:
1) разбор корневого урла
2) навигация в шапке (простейший случай, ссылки на логин, домашнюю и регистрацию)
3) у залогиненных есть возможность писать посты, которые будут видны всем.